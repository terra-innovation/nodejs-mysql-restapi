...
export const validateTransaction = async (req, res) => {
  ...
  logger.debug(line(), "empresaValidated:", usuariopedidoValidated);

  const transaction = await sequelizeFT.transaction();
  try {
    var camposUsuarioFk = {};
    var camposUsuarioAdicionales = {};
    camposUsuarioAdicionales.nombre = usuariopedidoValidated.nombre;

    var camposUsuarioAuditoria = {};
    ...
    logger.debug(line(), "pedidoCreated", pedidoCreated);
