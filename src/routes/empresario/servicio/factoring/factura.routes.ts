import * as facturaController from "#root/src/controllers/empresario/factoring/factura.Controller.js";
...
router.post("/empresario/servicio/factoring/factura/subir", isAuth, isRole([3]), catchedAsync(facturaController.subirFactura));
