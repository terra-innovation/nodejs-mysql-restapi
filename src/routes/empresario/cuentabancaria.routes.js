...
//Empresario
router.get("/empresario/cuentabancaria/listar", verifyToken, checkRole([2]), catchedAsync(cuentabancariaController.getCuentabancarias));
...
router.get("/empresario/cuentabancaria/master", verifyToken, checkRole([2]), catchedAsync(cuentabancariaController.getCuentabancariaMaster));
