...
router.patch("/admin/cuentasbancarias/actualizar/:id", verifyToken, checkRole([2]), catchedAsync(cuentasbancariasController.updateCuentabancariaOnlyAliasAndCuentaBancariaEstado));
