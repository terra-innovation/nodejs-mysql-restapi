import * as factoringliquidacionController from "#root/src/controllers/admin/servicio/factoring/factoringliquidacion.Controller.js";
...
router.get("/admin/servicio/factoring/factoringliquidacion/master/factoring/:factoringid", isAuth, isRole([2]), catchedAsync(factoringliquidacionController.getFactoringliquidacionMasterByFactoringid));
...
router.patch("/admin/servicio/factoring/factoringliquidacion/enviar/correo/:id", isAuth, isRole([2]), catchedAsync(factoringliquidacionController.sendCorreoFactoringliquidacion));
