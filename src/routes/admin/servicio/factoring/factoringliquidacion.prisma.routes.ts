...
router.get("/admin/servicio/factoring/factoringliquidacion/master", isAuth, isRole([2]), catchedAsync(factoringliquidacionController.getFactoringliquidacionMaster));
