...
export interface GetPreFacturaCedenteDto {
  factoringid: string;
...
/**
 * Consulta de catálogos maestros para factoring financiero (tipos, estados, riesgos).
 */
export const getFactoringMasterService = async () => {
  log.debug(line(), "service::financiero::getFactoringMasterService");
...
/**
 * Consulta de operaciones de factoring en estados activos/en proceso.
 */
export const getFactoringsService = async () => {
  log.debug(line(), "service::financiero::getFactoringsService");
...
/**
 * Consulta de operaciones de factoring pendientes de emisión de factura al cedente.
 */
 ...
 */
export const getPreFacturaCedenteService = async (dto: GetPreFacturaCedenteDto) => {
  log.debug(line(), "service::financiero::getPreFacturaCedenteService");
  const { factoringid, fecha_emision } = dto;
