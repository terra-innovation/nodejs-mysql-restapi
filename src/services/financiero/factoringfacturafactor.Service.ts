...
/**
 * Actualiza las condiciones de pago y estados de la factura del factor.
 */
export const updateFactoringfacturafactorService = async (dto: UpdateFactoringfacturafactorDto) => {
  log.debug(line(), "service::financiero::updateFactoringfacturafactorService");
...
/**
 * Registra la relación entre un factoring y la factura emitida por el factor.
 */
export const createFactoringfacturafactorService = async (dto: CreateFactoringfacturafactorDto) => {
  log.debug(line(), "service::financiero::createFactoringfacturafactorService");
